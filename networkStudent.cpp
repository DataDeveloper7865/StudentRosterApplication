/*
 * network student subclass for student
 */
...
networkStudent::networkStudent(string ID, string fn, string ln, string email,
...
enum Degree networkStudent::getDegreeProgram() {
    return deg; 
};
